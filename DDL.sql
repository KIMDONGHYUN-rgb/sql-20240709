...
-- 데이터 베이스 사용 : 작업을 수행하기 전에 반드시 작업할 데이터베이스를 입력
USE practice_sql;

-- 테이블 생성
example_tableexample_tableCREATE TABLE example_table (
	example_column1 INT,
...
-- 사용자 생성
-- CREATE USER '사용자명'@'접속IP' IDENTITFIED BY '비밀번호'
...
-- 테이블 컬럼 전체 수정
example_tableexample_tableALTER TABLE example_table
