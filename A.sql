...
-- 로그인
SELECT * FROM user
WHERE id = 'qwer' AND password = 'qwer';

SELECT * FROM user WHERE id = 'qwer';

-- 아이디 중복확인
SELECT * FROM user WHERE id = 'qwer';

-- 이메일 인증
INSERT INTO email_auth VALUES ('qwer@qwer.com', '1234');

-- 이메일 인증 확인
SELECT * FROM email_auth WHERE email = 'qwer@qwer.com' AND auth_number = '1234';

-- 회원가입
INSERT INTO user(id, password, email) VALUES ('qwer', 'qwer', 'qwer@qwer.com');
